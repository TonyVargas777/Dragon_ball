# Dragon Ball Image Hover Effect

Este proyecto es una aplicación desarrollada con **React** y **Vite** que presenta imágenes de personajes de Dragon Ball. Al pasar el mouse (hover) sobre las imágenes, estas se agrandan con un efecto visual atractivo.
...
![Dragon Ball](public/miniatura.avif)
...
1. Clona este repositorio:
   ```bash
   git clone https://github.com/TonyVargas777/Dragon_ball.git
   ```
...
3. Explora la galería de personajes de Dragon Ball.
...
¡Gracias por visitar este proyecto! Espero que te diviertas explorando los efectos de hover con imágenes de Dragon Ball. 🚀
